# linkedin-post-agent (Distributed)

A multi-agent system built with Google's Agent Development Kit (ADK) and Agent-to-Agent (A2A) protocol. It features a team of microservice agents that research, judge, and build content, orchestrated to deliver high-quality, engaging LinkedIn posts.
...
*   **Content Builder Service (`content_builder`):** A standalone agent that formats research into a high-engagement LinkedIn post.
